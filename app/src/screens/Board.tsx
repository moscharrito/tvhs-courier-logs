...
const styles = StyleSheet.create({
    ...
    sub: { fontSize: 16, color: theme.muted, marginBottom: 14 },
    shift: {
        borderWidth: 1, borderColor: theme.green, borderRadius: 18,
        paddingVertical: 14, alignItems: 'center', marginBottom: 14,
    },
    shiftOn: { backgroundColor: 'rgba(22,163,74,0.12)' },
    shiftText: { color: theme.green, fontSize: 17, fontWeight: '600' },
    shiftTextOn: { color: theme.green },
    tracking: { fontSize: 15, color: theme.muted, marginBottom: 10, paddingHorizontal: 4, lineHeight: 19 },
    carrying: { fontSize: 15, color: theme.muted, marginBottom: 12, paddingHorizontal: 4 },
    card: {
    ...
    cardPicked: { borderColor: theme.green, borderWidth: 2, backgroundColor: 'rgba(22,163,74,0.12)' },
    ...
    asked: { fontSize: 15, color: theme.green, marginTop: 8 },
    cardBody: { fontSize: 16, color: theme.muted },
    footnote: { fontSize: 15, color: theme.muted, lineHeight: 19, marginTop: 8, paddingHorizontal: 4 },
    ...
    note: { backgroundColor: 'rgba(22,163,74,0.12)', borderRadius: 18, padding: 14, marginBottom: 10 },
    noteText: { color: theme.green, fontSize: 16 },
    bar: {
        borderTopWidth: 1, borderTopColor: 'rgba(17,24,39,0.08)', backgroundColor: 'rgba(255,255,255,0.72)',
        padding: 14, paddingBottom: 22,
    },
    barWhy: { fontSize: 15, color: theme.muted, marginBottom: 10, textAlign: 'center' },
    ask: { backgroundColor: theme.green, borderRadius: 18, paddingVertical: 15, alignItems: 'center' },
    askOff: { opacity: 0.35 },
