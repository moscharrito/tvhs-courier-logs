...
const styles = StyleSheet.create({
    ...
    headline: { fontSize: 17, color: theme.ink, marginTop: 8, marginBottom: 18, lineHeight: 23 },
    card: {
    ...
    cardTitle: { fontSize: 17, fontWeight: '600', color: theme.ink, flex: 1 },
    cardBody: { fontSize: 16, color: theme.muted, marginTop: 8, lineHeight: 20 },
    pill: { fontSize: 15, color: theme.muted, flexShrink: 0, maxWidth: 150, textAlign: 'right' },
    pillDone: { color: theme.greenBright, fontWeight: '600' },
    sent: { fontSize: 15, color: theme.ink, marginTop: 10 },
    sendRow: { flexDirection: 'row', gap: 8, marginTop: 12, alignItems: 'center' },
    input: {
        flex: 1, backgroundColor: 'transparent', borderWidth: 1, borderColor: 'rgba(255,255,255,0.85)',
        borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, color: theme.ink,
    },
    send: { paddingHorizontal: 16, paddingVertical: 11, borderRadius: 8, borderWidth: 1, borderColor: theme.green },
    sendText: { color: theme.green, fontSize: 16, fontWeight: '600' },
    footnote: { fontSize: 15, color: theme.muted, lineHeight: 19, marginTop: 6, paddingHorizontal: 4 },
    error: { backgroundColor: 'rgba(185,28,28,0.1)', borderRadius: 18, padding: 14, marginBottom: 12 },
