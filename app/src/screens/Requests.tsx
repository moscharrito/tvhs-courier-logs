...
const styles = StyleSheet.create({
    ...
    cardTitle: { fontSize: 15, fontWeight: '600', color: theme.ink },
    cardBody: { fontSize: 15, color: theme.muted, lineHeight: 21 },
    link: { color: theme.green, fontSize: 14 },
    note: { borderTopWidth: 1, borderTopColor: theme.line, paddingVertical: 10, marginTop: 4 },
    noteUnread: { borderLeftWidth: 3, borderLeftColor: theme.greenBright, paddingLeft: 10 },
    noteText: { fontSize: 14, color: theme.ink, lineHeight: 20 },
    ...
    outcome: { fontSize: 15, color: theme.ink, marginTop: 10, lineHeight: 21 },
    outcomeGood: { color: theme.green, fontWeight: '600' },
    take: { alignSelf: 'flex-start', marginTop: 12, paddingVertical: 8 },
    takeText: { color: theme.muted, fontSize: 14 },
