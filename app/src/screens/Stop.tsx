...
const styles = StyleSheet.create({
    ...
    label: { fontSize: 13, color: theme.muted, marginTop: 16, marginBottom: 6 },
    input: {
        backgroundColor: theme.bg, borderWidth: 1, borderColor: theme.line, borderRadius: 8,
        paddingHorizontal: 12, paddingVertical: 12, fontSize: 16, color: theme.ink,
    },
    primary: { backgroundColor: theme.green, borderRadius: 10, paddingVertical: 16, alignItems: 'center', marginTop: 20 },
    ...
    secondaryText: { color: theme.green, fontSize: 16, fontWeight: '600' },
    cancel: { alignItems: 'center', paddingVertical: 14 },
    cancelText: { color: theme.muted, fontSize: 15 },
    reason: { borderWidth: 1, borderColor: theme.line, borderRadius: 8, padding: 14, marginBottom: 8 },
    reasonOn: { borderColor: theme.green, backgroundColor: theme.greenSoft },
    reasonText: { fontSize: 15, color: theme.ink },
    reasonTextOn: { color: theme.green, fontWeight: '600' },
    said: { backgroundColor: theme.greenSoft, borderRadius: 10, padding: 14, marginTop: 14 },
    saidText: { color: theme.green, fontSize: 15, lineHeight: 21 },
    footnote: { fontSize: 13, color: theme.muted, lineHeight: 19, marginTop: 14 },
});
