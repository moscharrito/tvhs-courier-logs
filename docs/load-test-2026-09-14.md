...
|---|---|
| Requests | 788 (12.9/s) |
| p50, once running | 16 ms |
| **p95, once running** | **105 ms** |
| p99, once running | 126 ms |
| Slowest, once running | 192 ms |
| p95, first 5 seconds | 113 ms |
| p95, everything | 110 ms |
| Failed requests | 0 |
...
decides nothing. Measured apart, both say something: the wave is 105 ms and the
opening burst is 113 ms.
...
|---|---|---|---|---|---|---|
| `POST /imports (300 rows)` | 1 | 280 ms | 280 ms | 280 ms | 0 | 0 |
| `GET /runs/:id/pickup` | 12 | 270 ms | 274 ms | 274 ms | 0 | 0 |
| `GET /board` | 87 | 81 ms | 131 ms | 192 ms | 0 | 0 |
| `POST /runs/:id/pickup` | 100 | 79 ms | 114 ms | 121 ms | 0 | 2 |
| `GET /runs/mine` | 12 | 59 ms | 86 ms | 86 ms | 0 | 0 |
| `POST /orders/:id/arrive` | 273 | 10 ms | 67 ms | 107 ms | 0 | 4 |
| `POST /orders/:id/deliver` | 273 | 8 ms | 44 ms | 126 ms | 0 | 4 |
| `POST /runs/:id/stops (move)` | 29 | 13 ms | 35 ms | 254 ms | 0 | 0 |
| `POST /imports/preview (300 rows)` | 1 | 28 ms | 28 ms | 28 ms | 0 | 0 |
